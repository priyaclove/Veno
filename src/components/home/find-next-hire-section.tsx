  ...
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-4 md:px-6 lg:px-12 py-16 bg-white">
        ...
        >
          <div className="relative rounded-2xl shadow-lg overflow-hidden">
            <Image src="/hero.webp" alt="Team" width={700} height={450} className="rounded-2xl" />
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-4 md:px-6 lg:px-12 py-16 bg-white">
        ...
        >
          <div className="relative rounded-2xl shadow-lg overflow-hidden">
            <Image src="/hero.webp" alt="Team" className="rounded-2xl object-cover" width={700} height={450} />
            {/* Red Curved Line Animation */}
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
